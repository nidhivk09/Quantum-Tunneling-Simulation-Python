...
class Wave_Packet:
    def __init__(self, n_points, dt, sigma0=5.0, k0=1.0, x0=-150.0, x_begin=-200.0,
                 x_end=200.0, barrier_height=1.0, barrier_width=3.0):#n_points-no of spatial points,dt-timestep,x0-initial position,ko-momentum,sigmao-width of wave packet,"""
        ...
        self.x, self.dx = sp.linspace(x_begin, x_end, n_points, retstep=True) #dx=grid spacing       
